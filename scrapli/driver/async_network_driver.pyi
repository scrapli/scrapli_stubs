...
class AsyncNetworkDriver(AsyncGenericDriver, NetworkDriverBase):
    ...
    async def send_commands(self, commands: List[str], strip_prompt: bool=..., failed_when_contains: Optional[Union[str, List[str]]]=..., stop_on_failed: bool=..., *, timeout_ops: Optional[float]=...) -> ScrapliMultiResponse: ...
    async def send_commands_from_file(self, file: str, strip_prompt: bool=..., failed_when_contains: Optional[Union[str, List[str]]]=..., stop_on_failed: bool=..., *, timeout_ops: Optional[float]=...) -> ScrapliMultiResponse: ...
    ...
    async def send_config(self, config: str, strip_prompt: bool=..., failed_when_contains: Optional[Union[str, List[str]]]=..., stop_on_failed: bool=..., privilege_level: str=..., *, timeout_ops: Optional[float]=...) -> Response: ...
    async def send_configs(self, configs: List[str], strip_prompt: bool=..., failed_when_contains: Optional[Union[str, List[str]]]=..., stop_on_failed: bool=..., privilege_level: str=..., *, timeout_ops: Optional[float]=...) -> ScrapliMultiResponse: ...
    async def send_configs_from_file(self, file: str, strip_prompt: bool=..., failed_when_contains: Optional[Union[str, List[str]]]=..., stop_on_failed: bool=..., privilege_level: str=..., *, timeout_ops: Optional[float]=...) -> ScrapliMultiResponse: ...
