...
from scrapli.driver.async_driver import AsyncScrape as AsyncScrape
...
class AsyncGenericDriver(AsyncScrape, GenericDriverBase):
    ...
    async def _send_command_eager(self, command: str, strip_prompt: bool=..., failed_when_contains: Optional[Union[str, List[str]]]=..., *, timeout_ops: Optional[float]=...) -> Response: ...
