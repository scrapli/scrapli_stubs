...
from scrapli.transport import ASYNC_TELNET_TRANSPORT_ARGS as ASYNC_TELNET_TRANSPORT_ARGS, AsyncTelnetTransport as AsyncTelnetTransport, SYSTEM_SSH_TRANSPORT_ARGS as SYSTEM_SSH_TRANSPORT_ARGS, SystemSSHTransport as SystemSSHTransport, TELNET_TRANSPORT_ARGS as TELNET_TRANSPORT_ARGS, TelnetTransport as TelnetTransport, TransportBase as TransportBase
...
class ScrapeBase:
    ...
    transport: Any = ...
    channel_args: Any = ...
    def __init__(self, host: str=..., port: int=..., auth_username: str=..., auth_password: str=..., auth_private_key: str=..., auth_private_key_passphrase: str=..., auth_strict_key: bool=..., auth_bypass: bool=..., timeout_socket: int=..., timeout_transport: int=..., timeout_ops: float=..., timeout_exit: bool=..., comms_prompt_pattern: str=..., comms_return_char: str=..., comms_ansi: bool=..., ssh_config_file: Union[str, bool]=..., ssh_known_hosts_file: Union[str, bool]=..., on_init: Optional[Callable[..., Any]]=..., on_open: Optional[Callable[..., Any]]=..., on_close: Optional[Callable[..., Any]]=..., transport: str=..., transport_options: Optional[Dict[str, Any]]=...) -> None: ...
    ...
    def _setup_timeouts(self, timeout_socket: int, timeout_transport: int, timeout_ops: float, timeout_exit: bool) -> None: ...
