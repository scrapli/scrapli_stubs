...
class AsyncChannel(ChannelBase):
    ...
    async def send_input(self, channel_input: str, strip_prompt: bool=...) -> Tuple[str, str]: ...
    async def _async_send_input(self, channel_input: str, strip_prompt: bool) -> Tuple[bytes, bytes]: ...
    async def send_inputs_interact(self, interact_events: List[Tuple[str, str, Optional[bool]]]) -> Tuple[str, str]: ...
