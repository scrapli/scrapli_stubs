from abc import ABC
from scrapli.helper import attach_duplicate_log_filter as attach_duplicate_log_filter, get_prompt_pattern as get_prompt_pattern, normalize_lines as normalize_lines
...
class ChannelBase(ABC):
    ...
    timeout_ops: Any = ...
    session_lock: Any = ...
    def __init__(self, transport: Union[Transport, AsyncTransport], comms_prompt_pattern: str=..., comms_return_char: str=..., comms_ansi: bool=..., comms_auto_expand: bool=..., timeout_ops: float=...) -> None: ...
