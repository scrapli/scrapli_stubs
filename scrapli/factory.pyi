...
def _get_driver_class(platform_details: Dict[str, Any], variant: Optional[str], _async: bool=...) -> Union[Type[AsyncNetworkDriver], Type[AsyncGenericDriver], Type[NetworkDriver], Type[GenericDriver]]: ...
